	...
	private String cha;
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(this.cha.equals("GuardCliente")){
				...
				if (q.clien.textClienApellido.getText()==null||q.clien.textClienCedu.getText()==null||q.clien.textClienDirec.getText()==null||q.clien.textClienNombre.getText()==null||q.clien.textClienTelf.getText()==null){
